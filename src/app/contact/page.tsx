...
export default function ContactPage() {
  return (
    <div className="grid grid-cols-2 gap-5 bg-white/70 p-7">
      <div className="space-y-10">
        ...
        <Section title="主動聯繫">
          <div className="mx-auto w-fit pb-5 pt-4 ">
            <p className="mb-4 text-nowrap text-green-200">
      ...
      <iframe
        ...
        className="aspect-[480/572] w-full border-none"
      ></iframe>
    </div>
  );
}
